        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    <h5><b>Form Edit Barang</b></h5>
                </div>

                <div class="card-body">
                    <form id="BRformadd" autocomplete="off" method="POST" action="<?= base_url('barang/edit/') . $barang[0]['barang_id']; ?>">
                        <div class="form-group">
                            <label>Nama Barang</label>
                            <input name="nabar" value="<?= $barang[0]['barang_nama']; ?>" class="form-control" type="text" placeholder="Nama Barang" required>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input value="<?= $barang[0]['barang_harpok_grosir']; ?>" name="harpok_grosir" class="harpok form-control" type="number" required>
                            </div>
                            <div class="col">
                                <label>Harga Modal Eceran</label>
                                <input value="<?= $barang[0]['barang_harpok_eceran']; ?>" name="harpok_eceran" class="harjul form-control" type="number" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input value="<?= $barang[0]['barang_harjul_grosir']; ?>" name="harjul_grosir" class="harjul form-control" type="number" required>
                            </div>

                            <div class="col">
                                <label>Harga Jual Eceran</label>
                                <input value="<?= $barang[0]['barang_harjul_eceran']; ?>" name="harjul_eceran" class="harjul form-control" type="number" required>
                            </div>
                        </div>
                        <hr color="grey" size="2">
                        <h5> <b> Member</b></h5>
                        <div class="row">
                            ...
                            <div class="col">
                                <label>Harga Jual Grosir</label>
                                <input  value="<?= $barang[0]['barang_harjul_grosir_m']; ?>" name="harjul_grosir_m" class="harjul form-control" type="number" required>
                            </div>

                            <div class="col">
                                <label>Harga Jual Eceran</label>
                                <input value="<?= $barang[0]['barang_harjul_eceran_m']; ?>" name="harjul_eceran_m" class="harjul form-control" type="number" required>
                            </div>
                        </div>
